...
import { source as l1s } from './data/icons/login-1';
import { source as l1 } from './data/login-1';
import { source as lg1 } from './data/landing-1';
import { source as lg1s } from './data/icons/landing-1';
import { source as lg2 } from './data/landing-2';
import { source as lg2s } from './data/icons/landing-2';
import { source as lg3 } from './data/landing-3';
import { source as lg3s } from './data/icons/landing-3';
import { source as acc1 } from './data/accordion-1';
...
const sources = [
  ...
  },
  {
    ...
    label: l1s,
    content: l1,
    category: 'Forms(Tailwind Collection)',
  },
  {
    id: 'landing-block-1',
    class: '',
